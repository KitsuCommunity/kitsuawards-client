...
const SignInContent = ({ modal }: { modal?: boolean }) => {
    ...
    return (
        ...
        >
            ...
            <p>
                Your password is only sent directly to Kitsu for verification.
                You can inspect the network requests by opening the dev tools
                (F12 or ctrl + shift + I) to verify.
            </p>
            <Input
                type="text"
                value={username}
