...
import type { SubcategoryFragment } from 'src/graphql/categories.generated';
        ...
        >
            ...
            {error && (
                <ErrorMessage>
                    {error?.message}
                    <br />
                    Please try again. If the error persists, please let Reina
                    know on{' '}
                    <a href="https://matrix.to/#/@reinacchan:matrix.org">
                        Matrix
                    </a>{' '}
