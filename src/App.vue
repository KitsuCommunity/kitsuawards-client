  ...
  <div id="app">
    <template v-if="year">
        <template>
            <b-navbar shadow fixed-top>
                ...
                <template slot="start">
                    ...
                    <b-navbar-item v-for="category in year[0].categories" :to="{ path: '/'+category.url }"
                    :key="category.id" :alt="category.name" tag="router-link">
                        {{category.name}}
                    </b-navbar-item>
                ...
                <template slot="end">
                    <b-navbar-item tag="div">
                        <div class="buttons">
                            <span class="isjudge" v-if="isJudge" type="is-primary" rounded outlined>JUDGE</span>
                            <b-navbar-item tag="router-link" :to="{ path: '/results' }" class="button is-light">
        ...
        <div v-if="year" id="router-view">
            <router-view :route="$route.fullPath" :data="year"/>
        </div>
        <footer class="footer">
        <div class="content has-text-centered">
            <p>
            The <strong>Kitsu Anime Awards</strong> are hosted by <a href="https://kitsu.io/users/Kuroonuma">Kuroonuma</a>.
            The website was made by <a href="https://kitsu.io/users/Gakamine">Gakamine</a>.
            </p>
            <p>
            All other trademarks and content not owned by the Kitsu Anime Awards that appear on the website are the property of their respective owners
            </p>
        </div>
        </footer>
      </template>
