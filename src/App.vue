    ...
    <template>
      <b-navbar shadow fixed-top>
          ...
          <template slot="start">
              ...
              <b-navbar-item tag="router-link" :to="{ path: '/nominees/music' }" >
                  Music Nominations
              </b-navbar-item>
              <b-navbar-item tag="router-link" :to="{ path: '/nominees/characters' }">
                  Characters Nominations
              </b-navbar-item>
              <b-navbar-item tag="router-link" :to="{ path: '/nominees/production' }">
                  Production Nominations
              </b-navbar-item>
              <b-navbar-item tag="router-link" :to="{ path: '/nominees/overall-award' }">
